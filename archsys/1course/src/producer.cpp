...
course::SimpleRequest course::Producer::produceRequest() { return SimpleRequest(getId(), getRequestCount()); }
...
course::Producer::requestid_t course::Producer::getRequestCount() const { return requestCount_; }
